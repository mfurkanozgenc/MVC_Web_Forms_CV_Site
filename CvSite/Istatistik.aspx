<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="Istatistik.aspx.cs" Inherits="CvProje.Istatistik" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="list_of_members" style="margin:20px">
        <div class="sales">
            <div class="icon">
                <i class="dollar"></i>
            </div>
